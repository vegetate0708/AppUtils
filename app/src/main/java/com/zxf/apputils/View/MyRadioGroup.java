...
/**
 * Created by xuefu on 2015/12/21.
 * 可进行多行多列相对摆放的RadioGroup 内部可以放置relativeLayout和LinearLayout
 * 使用放肆如下
 *
// * <com.zxf.apputils.View.MyRadioGroup
// android:id="@+id/rg_itemcontact_1"
...
// android:layout_width="wrap_content"
// android:layout_height="wrap_content"/>
// <RadioButton android:id="@+id/rb_answer"
// android:text="仅接打"
// android:layout_toRightOf="@+id/rb_out"
...
// android:layout_height="wrap_content"
// >
// <RadioButton android:id="@+id/rb_outandanswer"
// android:text="拨出接打"
// android:layout_width="wrap_content"
// android:layout_height="wrap_content"/>
// <RadioButton android:id="@+id/rb_null"
// android:text="禁止拨出接打"
// android:layout_toRightOf="@id/rb_outandanswer"
// android:layout_width="wrap_content"
// android:layout_height="wrap_content"/>
// </RelativeLayout>
// </com.zxf.apputils.View.MyRadioGroup>
    ...
    public class MyRadioGroup extends LinearLayout {
        ...
        public void addView(final View child, int index, ViewGroup.LayoutParams params) {
            if (child instanceof RadioButton) {
                ...
                int childCount = ((RelativeLayout) child).getChildCount();
                for(int i = 0; i < childCount; i++){
                    View view = ((RelativeLayout) child).getChildAt(i);
                    if (view instanceof RadioButton) {
                        final RadioButton button = (RadioButton) view;
        ...
        private void checkRadioButton(RadioButton radioButton){
            ...
            for(int i = 0; i < radioCount; i++){
                ...
                if (child instanceof RadioButton) {
                    ...
                    int childCount = ((RelativeLayout) child).getChildCount();
                    for(int j = 0; j < childCount; j++){
                        View view = ((RelativeLayout) child).getChildAt(j);
                        if (view instanceof RadioButton) {
                            final RadioButton button = (RadioButton) view;
                            if(button == radioButton){
                                // do nothing
